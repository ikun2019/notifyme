...
goog.exportSymbol('proto.user.UserStatsResponse', null, global);
/**
 ...
 * @constructor
 */
proto.user.UserStatsResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.user.UserStatsResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.user.UserStatsResponse.displayName = 'proto.user.UserStatsResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.user.UserInfoResponse.repeatedFields_ = [5];
...
proto.user.UserInfoResponse.prototype.getFollowedTagsList = function() {
  return /** @type{!Array<!proto.user.Tag>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.user.Tag, 5));
};
...
proto.user.UserInfoResponse.prototype.addFollowedTags = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 5, opt_value, proto.user.Tag, opt_index);
};
 ...
 * @return {!Object}
 */
proto.user.UserStatsResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.user.UserStatsResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.user.UserStatsResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.UserStatsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    postCount: jspb.Message.getFieldWithDefault(msg, 1, 0),
    thanksReceived: jspb.Message.getFieldWithDefault(msg, 2, 0),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.user.UserStatsResponse}
 */
proto.user.UserStatsResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.user.UserStatsResponse;
  return proto.user.UserStatsResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.user.UserStatsResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.user.UserStatsResponse}
 */
proto.user.UserStatsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.user.UserStatsResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.user.UserStatsResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.user.UserStatsResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.user.UserStatsResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPostCount();
  if (f !== 0) {
    writer.writeInt32(
...
/**
 * optional int32 post_count = 1;
 * @return {number}
 */
proto.user.UserStatsResponse.prototype.getPostCount = function() {
...
/**
 * @param {number} value
 * @return {!proto.user.UserStatsResponse} returns this
 */
proto.user.UserStatsResponse.prototype.setPostCount = function(value) {
  return jspb.Message.setProto3IntField(this, 1, value);
};


/**
 * optional int32 thanks_received = 2;
 * @return {number}
 */
proto.user.UserStatsResponse.prototype.getThanksReceived = function() {
 ...
 * @return {!proto.user.UserStatsResponse} returns this
 */
proto.user.UserStatsResponse.prototype.setThanksReceived = function(value) {
 ...
 * @return {number}
 */
proto.user.UserStatsResponse.prototype.getTotalViews = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};
 ...
 * @return {!proto.user.UserStatsResponse} returns this
 */
proto.user.UserStatsResponse.prototype.setTotalViews = function(value) {
  return jspb.Message.setProto3IntField(this, 3, value);
};
